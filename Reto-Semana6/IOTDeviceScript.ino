...
const char ssid[] = "vivoY33s"; // TODO cambiar por el nombre de la red WiFi
// Contraseña de la red WiFi
const char pass[] = "Thael2020."; // TODO cambiar por la contraseña de la red WiFi
//Conexión a Mosquitto
#define USER "ja.romerog12" // TODO Reemplace UsuarioMQTT por un usuario (no administrador) que haya creado en la configuración del bróker de MQTT.
const char MQTT_HOST[] = "54.173.179.229"; // TODO Reemplace ip.maquina.mqtt por la IP del bróker MQTT que usted desplegó. Ej: 192.168.0.1
...
const char MQTT_TOPIC_PUB[] = "colombia/atlantico/sabanagrande/" USER "/out"; //TODO Reemplace el valor por el tópico de publicación que le corresponde.
// El tópico de suscripción debe tener estructura: <país>/<estado>/<ciudad>/<usuario>/in
const char MQTT_TOPIC_SUB[] = "colombia/atlantico/sabanagrande/" USER "/in"; //TODO Reemplace el valor por el tópico de suscripción que le corresponde.
